  ...
  return (
    ...
    >
      <div style={{ display: 'flex', gap: '0.5rem' }}>
        ...
        <label htmlFor="fixed" style={{ cursor: 'pointer' }}>Despesa Fixa</label>
      </div>

      <div style={{ display: 'flex', gap: '0.5rem' }}>
        <input value="instalment" type="radio" name="repeat" id="instalment" onChange={(e) => setCurrentOption(e.target.value)} />
        <label htmlFor="instalment" style={{ cursor: 'pointer' }}>Despesa parcelada</label>
      </div>
          ...
          <FormContainer>
            ...
            <InputContainer>
              ...
              <Select name="category" id="category" defaultValue="DEFAULT" required>
                ...
                <option value="pc">Assinatura/Serviço</option>
